...
pub fn (c VersionCommand) arguments() []cmd.Argument {
	return []
}

pub fn (c VersionCommand) execute(mut sender cmd.Sender, ctx cmd.Context) ! {
	sender.send_message(ctx.lang.tf('cmd.version.body', {
