...
fn damage_held_item(mut tx WorldTx, mut s NetworkSession, amount int) {
...
// internally.
fn consume_held_item(mut tx WorldTx, mut s NetworkSession) {
...
fn player_for_epoch(mut tx WorldTx, runtime_id u64, epoch i64) ?&NetworkSession {
