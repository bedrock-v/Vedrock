...
pub const command_xp = 'vedrock.cmd.xp'
pub const command_spawnpoint = 'vedrock.cmd.spawnpoint'
...
fn new_registry() &Registry {
	...
	r.register(Permission{
		name:        command_xp
		description: 'Allows granting experience to players'
		default:     .op
	})
	r.register(Permission{
		name:        command_spawnpoint
		description: 'Allows setting where a player respawns'
		default:     .op
	})
	r.register(Permission{
