...
// and is not a player.
//
// Player deliberately doesn't satisfy it. Player's verbs take the world
// transaction that proves they run on the owning actor, and a source is reached
// from the session thread, where there is no transaction yet. What a command
// may do to a player is cmd.Sender which embeds this and adds the rest.
